require('./')([{
        ...
        {
            text: "Test a promise rejection after 10s",
            promise: new Promise((resolve, reject) => {
                setTimeout(() => {
        ...
        {
            text: "Test Command 3 (This does not run because the previous task throws an error)",
            command: "pwd",
            options: {cwd: "./server"},
